      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-600 mb-8">
            Connectez-vous pour continuer votre parcours beauté
          </p>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#5C4033] to-[#3E2A22] items-center justify-center p-12">
        <div className="max-w-md text-center text-white">
          ...
          <p className="text-gray-300 text-lg">
            Accédez à des analyses personnalisées, des routines sur mesure et suivez votre progression vers une peau rayonnante.
          </p>
        </div>
      </div>
    </div>
